...
class SearchConfig(BaseConfig):
    def build_parser(self):
        ...
        parser.add_argument('--data_path', help='data_path', default='/home/yyjiang/Projects/data/iccad19/iccad_2019_dct')
        parser.add_argument('--fealen', type=int, default=3, help='feature length')
        parser.add_argument('--val_set', required=True, help='validation_set')
        ...
        parser.add_argument('--save_dir', default='/home/yyjiang/Projects/bayes_darts/searchs', help='save_dir')
        parser.add_argument('--cutout_length', type=int, default=16, help='cutout length')
        parser.add_argument('--input_size', type=int, default=48, help='input size')
    ...
    def __init__(self):
        ...
        if self.input_size:
            self.data_path = os.path.join(self.data_path, '%dx%d'%(self.input_size, self.input_size))
...
class AugmentConfig(BaseConfig):
    def build_parser(self):
        ...
        parser.add_argument('--save_path', default='', help='save_path')
        parser.add_argument('--save_dir', default='/home/yyjiang/Projects/bayes_darts/augments', help='save_dir')
