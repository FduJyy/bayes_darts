...
# trn_transform, val_transform = preproc.data_transforms('iccad19', 16)
# start = time.time()
# dst = HsdDct('/home/yyjiang/Projects/data/iccad19/iccad_2019_dct/train', 32, transform=trn_transform)
# # print(len(dst))
# # for i in range(2):
# #     ft, label = dst[i]
# #     print(i, ft.shape,)
...
# train_loader = torch.utils.data.DataLoader(dst,
#             sampler=ImbalancedDatasetSampler(dst),
#             batch_size=32,
#             # shuffle=True,
#             num_workers=8,
#             pin_memory=True)
...
# trn_transform, val_transform = preproc.data_transforms('cifar10', 16)
# start = time.time()
# dst = dset.CIFAR10(root='/home/yyjiang/Projects/data/cifar10', train=True, download=True, transform=trn_transform)
# print(len(dst))
# for i in range(2):
#     ft, label = dst[i]
#     print(i, ft.shape)
...
# trndata = HsdDct('/home/yyjiang/Projects/data/iccad19/iccad_2019_dct/32x32/train', 2, None, 32)
# valdata = HsdDct('/home/yyjiang/Projects/data/iccad19/iccad_2019_dct/32x32/test/0', 2, None, 32)
# print(trndata.label_buffer)
# print(trndata.label_buffer.shape, trndata.label_buffer.sum())
# print(valdata.label_buffer)
# aug_data_binary(trndata, valdata)
# print(trndata.label_buffer)
# print(trndata.label_buffer.shape, trndata.label_buffer.sum())
# print(valdata.label_buffer)
